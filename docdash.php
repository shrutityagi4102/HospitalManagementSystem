    ...
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <a href="docdash.html" class="logo">
            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="login3.html">Logout</a>
                    </div>
                </li>
            </ul>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="docdash.html"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                        ...
                        <li>
                            <a href="nurses.html"><i class="fa fa-hospital-o"></i> <span>Nurses</span></a>
                        </li>
                        <li>
                            <a href="appointments.html"><i class="fa fa-calendar"></i> <span>Appointments</span></a>
                        </li>
                        <li>
                            <a href="salary.html"><i class="fa fa-book"></i> <span> Salary</span></a>
                    ...
                    <div class="col-12 col-md-6 col-lg-8 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title d-inline-block">Patients Data </h4> <a href="patients.html" class="btn btn-primary float-right">View all</a>
                            </div>
                            ...
                            <div class="card-body">
                                <ul class="contact-list">
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.html" title="John Doe"><img src="assets/img/cardio.png" alt="" class="w-40 rounded-circle"></a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.html" title="Richard Miles"><img src="assets/img/gyna.png" alt="" class="w-40 rounded-circle"></a>
                                            </div>
                                            <div class="contact-info">
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.html" title="John Doe"><img src="assets/img/gs.png" alt="" class="w-40 rounded-circle"></a>
                                            </div>
                                            <div class="contact-info">
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.html" title="Richard Miles"><img src="assets/img/ent.png" alt="" class="w-40 rounded-circle"></a>
                                            </div>
                                            <div class="contact-info">
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.html" title="John Doe"><img src="assets/img/can.png" alt="" class="w-40 rounded-circle"></a>
                                            </div>
                                            <div class="contact-info">
