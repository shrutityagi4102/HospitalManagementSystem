...
$db= $conn;
    $tableName = "patient";
    $columns = ['id','name','gender','address','medical_record','contact_number','room_no','payment_status','department','diagnosis','age'];
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-patient0.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Patient</a>
                    </div>
                </div>
                <div class="container">
                <div class="row">
                ...
                <?php
                    ...
                    <td><?php echo $data['medical_record']??''; ?></td>
                    <td><?php echo $data['room_no']??''; ?></td> 
                    <td><?php echo $data['address']??''; ?></td>  
                    <td><?php echo $data['contact_number']??''; ?></td>  
                    <td><?php echo $data['payment_status']??''; ?></td>  
                    <td><a class="dropdown-item" href="edit-patient0.php?edit=<?php echo $data['id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></td>
                    <td>
                    <a href="updatepatient0.php?del=<?php echo $data['id']; ?>" data-dismiss="modal"><div class="m-t-20"><button type="submit" class="btn btn-danger">Delete</button></div></a>
                    </td>
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
                            <button type="submit" class="btn btn-danger"><a href="updatepatient0.php?del=<?php echo $data['id']; ?>">Delete</a></button>
                        </div>
                    </div>
                </div>
            </div>
