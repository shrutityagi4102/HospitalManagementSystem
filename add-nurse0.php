    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="insertnurse0.php" name="myForm" onsubmit="return validateForm() && display()" method = "post"> 
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="m-t-20 text-center">
                                <button type="submit" name="submit" action="/admindash.php" class="btn btn-primary submit-btn">Create Nurse</button>
                            </div>
                        </form>
                    </div>
                </div>
