            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-nurse0.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Nurse</a>
                    </div>
                </div>
                ...
                <?php
                    ...
                    <td><a class="dropdown-item" href="edit-nurse0.php?edit=<?php echo $data['id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></td>
                   
                    <td>
                    <a href="updatenurse0.php?del=<?php echo $data['id']; ?>" data-dismiss="modal"><div class="m-t-20"><button onclick="myFunction()" type="submit" class="btn btn-danger">Delete</button></div></a>
                    </td>

                    <!-- <td>
                    <div class="m-t-20"><button onclick="myFunction()" type="submit" class="btn btn-danger">Delete</button></div>
                    </td> -->
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
                            <button type="submit" class="btn btn-danger"><a href="updatenurse0.php?del=<?php echo $data['id']; ?>">Delete</a></button>
                        </div>
                    </div>
                </div>
            </div>
